...
class ConnectorOrchestrator:
    ...
    def __init__(
        ...
        self._usdt_usd_tick: Optional[PriceTick] = None
    ...
    def get_usdt_usd_rate(self) -> Optional[float]:
    ...
    @property
    def usdt_usd_tick(self) -> Optional[PriceTick]:
        """Get the raw USDCUSDT tick for USDT/USD conversion."""
        return self._usdt_usd_tick
    
    def get_binance_price(self, coin: str) -> Optional[PriceTick]:
    ...
    def get_chainlink_price(self, coin: str) -> Optional[ChainlinkPriceTick]:
    ...
    def get_binance_price_usd(self, coin: str) -> Optional[float]:
    ...
    def get_market_by_series(self, series_key: str) -> Optional[MarketSpec]:
    ...
    def get_market_by_expiry(self, expiry_key: str) -> Optional[MarketSpec]:
    ...
    def get_polymarket_prices(self, series_key: str) -> Optional[Dict[str, MarketPriceTick]]:
    ...
    def get_unified_snapshot(self, series_key: str) -> Optional[Dict[str, Any]]:
