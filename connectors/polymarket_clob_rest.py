...
class PolymarketClobRestConnector(BaseConnector):
    ...
    def _fetch_token_price(self, token_id: str) -> dict[str, Any] | None:
        """
    ...
    def fetch_once(self, token_ids: list[str] | None = None) -> dict[str, float]:
        """
...
class PolymarketPriceFetcher:
    ...
    def fetch_prices(self, token_ids: list[str]) -> dict[str, float | None]:
        """
